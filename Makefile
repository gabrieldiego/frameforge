...
help:
	...
	@printf '%s\n' '  make validate-set [CODEC=vvc|av2 VALIDATION_SET=smoke VALIDATION_SET_DIR=verification/test_vector_sets VALIDATION_LIMIT=<n> VALIDATION_WITH_SYNTH=0|1 VALIDATION_STOP_ON_FAIL=0|1] - generate and run a named validation set; AV2 currently supports the 64x64 black 4:4:4 software path'
