...
async def coding_tree_scheduler_selects_local_body_kind(dut):
    ...
    await check_geometry(dut, 16, 16, 16, 16, BODY_GENERATED)
    await check_geometry(dut, 4, 16, 16, 16, BODY_GENERATED)
    await check_geometry(dut, 32, 32, 32, 32, BODY_GENERATED)
    await check_geometry(dut, 32, 16, 32, 32, BODY_GENERATED)
    await check_geometry(dut, 16, 32, 32, 32, BODY_GENERATED)
