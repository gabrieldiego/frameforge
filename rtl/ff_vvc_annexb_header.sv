...
module ff_vvc_annexb_header (
  ...
  localparam logic [6:0] SPS_FIELD_COUNT = 7'd105;
  ...
  logic [15:0] crop_right_420;
  logic [15:0] crop_bottom_420;
  ...
  assign crop_right_420 = (coded_width - visible_width) >> 1;
  assign crop_bottom_420 = (coded_height - visible_height) >> 1;
  ...
  always_comb begin
    ...
    if (!nal_is_pps_q) begin
      case (field_index_q)
        ...
        7'd3: begin syntax_value = 32'd1; syntax_bits = 6'd2; end  // sps_chroma_format_idc
        ...
        7'd6: begin syntax_value = 32'd1; syntax_bits = 6'd7; end  // general_profile_idc
        ...
        7'd41: begin syntax_value = 32'd1; syntax_bits = 6'd1; end // sps_qtbtt_dual_tree_intra_flag
        7'd42: begin syntax_value = 32'd2; syntax_bits = 6'd3; end // chroma ue(1)
        7'd43: begin syntax_value = 32'd4; syntax_bits = 6'd5; end // chroma ue(3)
        7'd44: begin syntax_value = 32'd4; syntax_bits = 6'd5; end // chroma ue(3)
        7'd45: begin syntax_value = 32'd3; syntax_bits = 6'd3; end // chroma ue(2)
