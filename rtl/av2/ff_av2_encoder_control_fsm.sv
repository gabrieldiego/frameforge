...
module ff_av2_encoder_control_fsm #(
  ...
  input logic [1:0] decision_ibc_drl_idx_w,
  input logic decision_ibc_use_copy_w,
  ...
  input logic decision_leaf_chroma_bdpcm_horz_w,
  ...
  input logic [1:0] decision_leaf_luma_mode_w,
